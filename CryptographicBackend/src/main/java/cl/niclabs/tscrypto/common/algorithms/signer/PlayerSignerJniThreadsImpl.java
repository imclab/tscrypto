...
public class PlayerSignerJniThreadsImpl extends AbstractPlayerSigner {
     ...
     * @param id  player id
     */
   public PlayerSignerJniThreadsImpl(KeyShareInfo key, int id, int threads){
       super(key, id);
